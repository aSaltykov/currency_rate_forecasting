...
def plot_arima(currency, testing_actual, testing_predict, file_name):
    actual = pyplot.plot(testing_actual, label="Actual data points", color="darkslategrey")
    testing = pyplot.plot(testing_predict, label="Testing prediction", color="crimson")
...
def arima_model(currency):
    ...
    plot_arima(currency, testing_actual_arima, testing_predict_arima, "testing_prediction_arima")
